...
class _EditState extends State<Edit> {
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://192.168.100.70/MOBILE/UAS_Mobile/detail.php?id='${widget.id}'"));
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.100.70/MOBILE/UAS_Mobile/update.php"),
        body: {
          "id": widget.id,
          "title": title.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.100.70/MOBILE/UAS_Mobile/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    return 'Konten Note Harus Diisi!';
                  }
                  return null;
                },
              ),
